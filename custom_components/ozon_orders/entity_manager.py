...
from .binary_sensor import OzonOrderBinarySensor
from .coordinator import OzonOrdersCoordinator
from .sensor import OzonOrderStatusSensor


class OzonOrderEntityManager:
    ...
    def _async_add_order_entities(self) -> None:
        ...
        for key in sorted(new_keys):
            sensors.append(OzonOrderStatusSensor(self.coordinator, key))
            binaries.append(OzonOrderBinarySensor(self.coordinator, key, "at_pickup"))
            binaries.append(OzonOrderBinarySensor(self.coordinator, key, "in_transit"))
