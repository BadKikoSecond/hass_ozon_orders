"""Sensor platform for Ozon Orders."""
...
async def async_setup_entry(
    ...
    async_add_entities(OzonHubSensor(coordinator, description) for description in HUB_SENSORS)
    register_platform_add_entities(hass, entry, "sensor", async_add_entities)


class OzonHubSensor(CoordinatorEntity[OzonOrdersCoordinator], SensorEntity):
    """Summary and session sensors on the Ozon hub device."""

    entity_description: SensorEntityDescription

    def __init__(
        self,
        coordinator: OzonOrdersCoordinator,
...
class OzonOrderStatusSensor(CoordinatorEntity[OzonOrdersCoordinator], SensorEntity):
    ...
    def __init__(self, coordinator: OzonOrdersCoordinator, order_key: str) -> None:
        super().__init__(coordinator)
