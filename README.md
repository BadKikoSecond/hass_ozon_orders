...
- Запросы идут через **curl_cffi** с TLS-отпечатком Chrome (`impersonate=chrome`).
- Ozon (Variti) иногда требует **challenge в браузере** — это нельзя обойти только cookies из HA.
- Если видите 403/challenge: откройте ozon.ru на ПК, пройдите проверку, **подождите 10–15 минут**, экспортируйте **все** cookies `.ozon.ru`, обновите интеграцию **один раз**.
- Не спамьте повторными попытками — IP уходит в более жёсткий бан.
